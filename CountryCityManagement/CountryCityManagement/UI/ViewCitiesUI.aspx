<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ViewCitiesUI.aspx.cs" Inherits="CountryCityManagement.UI.ViewCitiesUI" %>
...
<body>
    <form id="form1" runat="server">
        <div style="height: 505px">
            ...
            <br />
            <br />
            <asp:Panel ID="searchPanel" runat="server" BackColor="#FFF8F0" BorderColor="#FFDDBB" BorderStyle="Solid" Height="161px" Style="margin-left: 155px" Width="612px">
